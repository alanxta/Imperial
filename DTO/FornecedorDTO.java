...
public int getIdFornecedor(){
    ...
    public String getNomeFantasiaFornecedor (String nomeFantasiaFornecedor){
    ...
    public void setNomeFantasiaFornecedor(String nomeFantasiaFornecedor){
      ...
      public String getRazaoSocialFornecedor (String razaoSocialFornecedor){
    ...
    public void setRazaoSocialFornecedor(String razaoSocialFornecedor){
        this.razaoSocialFornecedor = razaoSocialFornecedor;
         ...
         public String getCepFornecedor (String cepFornecedor){
    ...
    public void setCepFornecedor(String cepFornecedor){
        ...
        public String getEnderecoFornecedor (String enderecoFornecedor){
    ...
    public void setEnderecoFornecedor(String enderecoFornecedor){
        this.enderecoFornecedor = enderecoFornecedor;
         ...
         public String getTelefoneFornecedor (String telefoneFornecedor){
  ...
  public String getEmailFornecedor (String emailFornecedor){
